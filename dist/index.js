(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("react/jsx-runtime"), require("next/image.js"), require("react"), require("react-icons/bi/index.esm.js"), require("react-icons/pi/index.esm.js"), require("react-dom"), require("clsx"), require("tailwind-merge"), require("class-variance-authority"), require("react-responsive"), require("react-firebase-hooks/auth/dist/index.esm.js")) : typeof define === "function" && define.amd ? define(["exports", "react/jsx-runtime", "next/image.js", "react", "react-icons/bi/index.esm.js", "react-icons/pi/index.esm.js", "react-dom", "clsx", "tailwind-merge", "class-variance-authority", "react-responsive", "react-firebase-hooks/auth/dist/index.esm.js"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.ui = {}, global["react/jsx-runtime"], global.Image, global.React, global.index_esm_js, global.index_esm_js$1, global.ReactDOM, global.clsx, global.tailwindMerge, global.classVarianceAuthority, global.reactResponsive, global.index_esm_js$2));
})(this, function(exports2, jsxRuntime, Image, React, index_esm_js, index_esm_js$1, ReactDOM, clsx, tailwindMerge, classVarianceAuthority, reactResponsive, index_esm_js$2) {
  ...
  const Avatar = ({ size: size2 = 24, isSubscriber = false, src, className = "" }) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(
      "div",
      {
        ...
        children: [
          src ? /* @__PURE__ */ jsxRuntime.jsx(Image, { src, className: "rounded-full !relative", fill: true, alt: "@avatar" }) : /* @__PURE__ */ jsxRuntime.jsx(index_esm_js.BiUser, { size: size2 / 2 }),
          isSubscriber && /* @__PURE__ */ jsxRuntime.jsx("div", { style: {
            // maxWidth: '64px',
            // maxHeight: '64px',
          ...
          }, className: "absolute flex items-center justify-center border-2 rounded-full text-muted-foreground border-background bg-muted", children: /* @__PURE__ */ jsxRuntime.jsx(index_esm_js$1.PiCrownSimpleBold, { size: iconSize }) })
        ]
      }
    );
  };
  ...
  const PopoverContent = React__namespace.forwardRef(({ className, align = "center", sideOffset = 4, ...props }, ref) => /* @__PURE__ */ jsxRuntime.jsx($cb5cc270b50c6fcd$export$602eac185826482c, { children: /* @__PURE__ */ jsxRuntime.jsx(
  ...
  const ProjectsGrid = () => {
    return /* @__PURE__ */ jsxRuntime.jsxs(Popover, { children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx(PopoverContent, { className: "h-96 grid p-4 grid-cols-3 grid-rows-6", children: projects.map(
        (project) => /* @__PURE__ */ jsxRuntime.jsxs("a", { href: project.link, className: "w-full h-full flex flex-col items-center justify-center gap-2", children: [
          /* @__PURE__ */ jsxRuntime.jsx("div", { className: "w-7 h-7 relative", children: /* @__PURE__ */ jsxRuntime.jsx("img", { src: project.icon, className: "w-full h-full", alt: "project-icon" }) }),
  ...
  const DesktopMenu = ({ auth }) => {
    index_esm_js$2.useAuthState(auth);
  ...
  const UserCircle = ({ auth }) => {
    ...
    if (!auth)
      return /* @__PURE__ */ jsxRuntime.jsx("div", { className: "w-9 h-9 rounded-full bg-muted" });
    if (!isTabletOrMobile)
